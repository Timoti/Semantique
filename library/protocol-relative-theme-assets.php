 ...
 *
 * @package Semantique
 * @since Semantique 1.1.0
 */

if ( ! class_exists( 'semantique_Protocol_Relative_Theme_Assets' ) ) :
	class semantique_Protocol_Relative_Theme_Assets {
		/**
	...
	$semantique_protocol_relative_theme_assets = new semantique_Protocol_Relative_Theme_Assets;
endif;
