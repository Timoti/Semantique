...
get_header(); ?>
	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<div class="kitchen-sink" id="kitchen-sink" role="main">
			<header>
			...
			<div class="components" id="components">
				...
				<article <?php post_class() ?> id="post-<?php the_ID(); ?>">
					...
					<!-- Abide -->
					<h2 id="abide" class="abide docs-heading" data-magellan-target="abide"><a href="abide"></a>Abide</h2>
					<form data-abide novalidate>
						...
						<div class="row">
							<div class="small-12 columns">
								...
								<p class="help-text exampleHelpText" id="exampleHelpText">Here's how you use this input field!</p>
							</div>
							<div class="small-12 columns">
								<label>Nothing Required!
									<input type="text" placeholder="Use me, or don't" aria-describedby="exampleHelpTex" data-abide-ignore>
								</label>
								<p class="help-text exampleHelpText" id="exampleHelpText">This input is ignored by Abide using `data-abide-ignore`</p>
							</div>
							<div class="small-12 columns">
								<label>Password Required
									<input type="password" class="password" id="password" placeholder="yeti4preZ" aria-describedby="exampleHelpText" required >
									<span class="form-error">
										I'm required!
									</span>
								</label>
								<p class="help-text exampleHelpText" id="exampleHelpText">Enter a password please.</p>
							</div>
							<div class="small-12 columns">
								...
								<p class="help-text exampleHelpText2" id="exampleHelpText2">This field is using the `data-equalto="password"` attribute, causing it to match the password field above.</p>
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<fieldset class="large-6 columns">
								...
								<input type="radio" name="pokemon" value="Red" class="pokemonRed" id="pokemonRed"><label for="pokemonRed">Red</label>
								<input type="radio" name="pokemon" value="Blue" class="pokemonBlue" id="pokemonBlue" required><label for="pokemonBlue">Blue</label>
								<input type="radio" name="pokemon" value="Yellow" class="pokemonYellow" id="pokemonYellow"><label for="pokemonYellow">Yellow</label>
							</fieldset>
							<fieldset class="large-6 columns">
								<legend>Choose Your Favorite - not required, you can leave this one blank.</legend>
								<input type="radio" name="pockets" value="Red" class="pocketsRed" id="pocketsRed"><label for="pocketsRed">Red</label>
								<input type="radio" name="pockets" value="Blue" class="pocketsBlue" id="pocketsBlue"><label for="pocketsBlue">Blue</label>
								<input type="radio" name="pockets" value="Yellow" class="pocketsYellow" idclass="pocketsYellow" ><label for="pocketsYellow">Yellow</label>
							</fieldset>
							<fieldset class="large-6 columns">
								<legend>Check these out</legend>
								<input class="checkbox1" id="checkbox1" type="checkbox"><label for="checkbox1">Checkbox 1</label>
								<input class="checkbox2" id="checkbox2" type="checkbox" required><label for="checkbox2">Checkbox 2</label>
								<input class="checkbox3" id="checkbox3" type="checkbox"><label for="checkbox3">Checkbox 3</label>
							</fieldset>
						</div>
						<div class="row">
							<fieldset class="large-6 columns">
					...
					<!-- Accordion -->
					<h2 class="accordion" id="accordion" class="docs-heading" data-magellan-target="accordion"><a href="#accordion"></a>Accordion</h2>
					<ul class="accordion" data-accordion role="tablist">
						<li class="accordion-item">
							<!-- The tab title needs role="tab", an href, a unique ID, and aria-controls. -->
							<a href="#panel1d" role="tab" class="accordion-title panel1d-heading" id=" panel1d-heading" aria-controls="panel1d">Accordion 1</a>
							<!-- The content pane needs an ID that matches the above href, role="tabpanel", data-tab-content, and aria-labelledby. -->
							<div id="panel1d" class="accordion-content panel1d" role="tabpanel" data-tab-content aria-labelledby="panel1d-heading">
								Panel 1. Lorem ipsum dolor
							</div>
						</li>
						<li class="accordion-item">
							<!-- The tab title needs role="tab", an href, a unique ID, and aria-controls. -->
							<a href="#panel1d" role="tab" class="accordion-title" class="panel1d-heading" id="panel1d-heading" aria-controls="panel1d">Accordion 1</a>
							<!-- The content pane needs an ID that matches the above href, role="tabpanel", data-tab-content, and aria-labelledby. -->
							<div id="panel1d" class="accordion-content panel1d" role="tabpanel" data-tab-content aria-labelledby="panel1d-heading">
						...
						<li class="accordion-item">
							<!-- The tab title needs role="tab", an href, a unique ID, and aria-controls. -->
							<a href="#panel1d" role="tab" class="accordion-title panel1d" id="panel1d-heading" aria-controls="panel1d">Accordion 1</a>
							<!-- The content pane needs an ID that matches the above href, role="tabpanel", data-tab-content, and aria-labelledby. -->
							<div id="panel1d" class="accordion-content panel1d" role="tabpanel" data-tab-content aria-labelledby="panel1d-heading">
					...
					<!-- Accordion Menu -->
					<h2 id="accordion-menu" class="docs-heading accordion-menu" data-magellan-target="accordion-menu"><a href="#accordion-menu"></a>Accordion Menu</h2>
					...
					<!-- Badge -->
					<h2 id="badge" class="docs-heading badge" data-magellan-target="badge"><a href="#badge"></a>Badge</h2>
					...
					<!-- Breadcrumbs -->
					<h2 id="breadcrumbs" class="docs-heading breadcrumbs" data-magellan-target="breadcrumbs"><a href="#breadcrumbs"></a>Breadcrumbs</h2>
